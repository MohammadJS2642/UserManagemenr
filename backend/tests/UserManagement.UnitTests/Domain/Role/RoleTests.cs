...
namespace UserManagement.Domain.UnitTests.Domain.Role;
...
public class RoleTests
{
    ...
    {
        var role = new Entities.Role("Admin");
    ...
    {
        var role = new Entities.Role("User");
    ...
    {
        var role = new Entities.Role("Moderator");
        role.Remove();
